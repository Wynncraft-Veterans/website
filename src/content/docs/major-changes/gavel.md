...
<details>
<summary>Click this for more info about the many froms that keys can take. They still open the same dungeons, but may not stack for a variety of reasons</summary>
<p>Currently, there are 5 states of (broken or regular) dungeon keys that you can end up with:</p>
