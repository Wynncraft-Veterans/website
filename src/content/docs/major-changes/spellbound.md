...
Notwithstanding some major changes in 2014 which were major enough to warrant [their own article](https://www.wynnvets.org/docs/major-changes/mobs/#eula-changes) and some major cosmetic changes in 2025 which were also major enough to warrent [their own article](https://www.wynnvets.org/docs/major-changes/rekindled/#store-stuffs), most of Wynn's store changes have been relatively gradual.
...
### Normal Ranks
Currently, Wynn's paid rank structure is as follows:
**Default < VIP < VIP+ < HERO < HERO+ < CHAMPION**
These ranks were respectively implemented after 0.0, 1.0, 1.14, 2.1, and 1.20.
