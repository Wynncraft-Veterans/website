...
In general, you can grind for XP at any level, but this guide will provide a strategy to get you from level 1 to 105 in a matter of 4-6 hours. Whether you prefer to grind in a party or solo, this guide covers everything. It's a tried-and-tested guide, which I have used to get 11 classes to level 100+.

There is a quick guide for those who don't want to know the details and a more comprehensive, in-depth guide further down the page.

---

## Quick Guide

### Grinding Meta vs. My Suggestion:

*   **Meta Grinding Spots:** Corrupted Spike to lvl 5 -> Zombie Tree to ~lvl 30 -> Llevigar Spider Nest to ~lvl 55 -> Flesh Cave to ~lvl 70 -> Waterfall to ~lvl 85 -> Scrapyard to lvl 105
*   **My Suggestion:** Corrupted Spike to lvl 5 -> Zombie Tree to lvl 13 or 25 -> Ancient Nemract to lvl 23 -> Abandoned Mines to lvl 33 -> Betrayer Altar or Wolf Den to lvl 43 -> Iron Golems to lvl 50 -> Olux Sinkhole to lvl 55 -> Flesh Cave to lvl 76 -> Scrapyard to Lvl 105

**Quick Tip:** As long as no other player is nearby, you can use the `/class` command to reset the area, causing mobs to respawn quickly after rejoining.

**Party Grinding:** If possible, you should always grind in a party. This ensures safety and increases XP gain. This is especially true for the Spider Nest, Flesh Cave, Waterfall, and Scrapyard.
...
There are a few sets of equipment that I would recommend you use. For details on the sets, look at the detailed guide further down.

*   **Morph Set [12-105]:** From level 12 to the end, it can always be used.
*   **Adventure Set [lvl 29]:** This set works from level 29 up to around level 45.
*   **Outlaw Set [lvl 39]:** This set can be worn from level 39 up to level 60. It's not that great for XP, but it works well for sustain.
*   **Elf Set [lvl 50]:** A good set for survivability that can be used until the Saint Set.
*   **Winterfest 2016 Set [lvl 55]:** Can be used from level 55 onwards until you can equip more Morph parts (Level 75), or longer if you don't go for the Morph set.
*   **Saint Set [lvl 70]:** A great set for endgame grinding, offering good tankiness and sustain.
*   **Cosmic Set [lvl 80]:** The best XP set in the game, but it requires the character to complete the '???' quest (covered in another guide).

The meta progression is just the Adventure Set into the Morph Set, but I would recommend more:

If you only want to use sets, then I would go for:
Morph Rings -> Full Adventure Set -> Full Outlaw Set -> Full Elf Set -> Full Winterfest 2016 Set -> Full Saint Set -> Full Morph

This is one of the cheapest ways (totaling around 10 Liquid Emeralds) to get to higher levels without problems.

## Detailed Guide

### Tricks for Faster Grinding:

*   **The `/class` Trick:** When you use the `/class` command and no other players are nearby, you reset the area you are in. After rejoining, the mobs will respawn instantly. This allows you to clear caves and grinding spots repeatedly without waiting for respawns.

*   **Horses:** Having a horse for the early levels can be quite beneficial for getting around, as horses can be used from level 1.

*   **Organized Storage:** Preparing one or two account bank pages with all the leveling gear you need can speed up the leveling process considerably. Taking some gear with you to grinding spots also helps increase your speed.

*   **Item Lock:** Remember to use `/itemlock` so you don’t accidentally sell an important item or drop your weapon. The item lock remains even if you put items in the bank, so locking your grinding gear beforehand is a good idea.

*   **Consumables:** Potions are your bread and butter for speeding up your grind, whether it's healing for classes that lack it or Wisdom Potions for the added XP bonus from level 45 onwards. If you already have professions in Scribing, Cooking, or Alchemism, you can use these to craft XP or damage consumables to speed up your grind even more. XP Scrolls, in particular, will earn you favor in grinding parties.

*   **XP-Bombs or Double XP Weekend:** XP multipliers from bombs or a Double XP Weekend work independently of the normal XP bonus; they act as a straight 2x or 3x multiplier. The same applies if you connect Discord to your Wynn account for 24 hours of bonus XP. If you have a lot of Emeralds, you can go out of your way to buy them with Shares, but that's a steep price to pay. Champions have it quite a lot easier, as they can see other people throwing bombs on any world and have access to `/switch` for faster world switching, rapidly increasing their chances of using these bombs.

*   **Mob Totems:** These require a rank to obtain and, when placed, multiply the number of mobs spawned in a small area for 5 minutes. They are primarily used in grinding parties.

*   **Sneaking:** Sneaking prevents mobs from pulling or pushing you off ledges. In the Minecraft settings, you can change "Hold Sneak" to "Toggle Sneak," allowing you to keep sneaking without actively pressing the shift key. This enables you to farm safely from secure spots.
...
<details>
<summary><strong>Click to see the List of all Grinding Spots</strong></summary>
...
Levels 45–60 are a little boring, this is where the grind slows down. This range demands a little more patience because there are no fast Party grinding areas.

*   **Lvl 40-50: Iron Golem Cave**
...
*   **Lvl 52-82: [Meta] Flesh Cave/Visceral Cave/Visceral Remnant**
    *   **Coordinates:** X: -1000, Z: -5555
    *   **Mob-Level:** 68-75
    *   This cave is the first real grind spot in the game. There is a very high mob density, and grind parties tend to be here a lot. There are a few safe spots in the cave; my favorite is at `X: -948, Z: -5517`. It keeps you safe from all mobs and out of range of the Stitched Amalgam. There is a spot at `X: -972, Z: -5530` which is higher up and attracts more mobs, but it's a bit difficult to get to consistently. The last one is at `X: -978, Z: -5500`; this will attract all higher-level mobs as well as the Stitched Amalgam. The Stitched Amalgam is a problem as it pulls you towards itself and has a lot of HP, so you can't really kill it fast. To get around that, change your Sneak setting from "Hold" to "Toggle" in the options and toggle sneak on a ledge. It can't pull you down, and you can freely farm. It's up to preference which spot to use. If there are grinding parties, however, you should stay near the totems or at the end of the cave (around `X: -965, Z: -5475`). A party with mob totems is recommended here but not required. This cave can be used from as low as level 46 up to level 85. You can use the `/class` trick here, but it's not really needed. I use it if there is no party around and if I have no totems left.
...
*   **Shaman – Summoner:** They have the easiest time in any grind. Due to their puppets targeting the same enemy and attacking very quickly, it's almost guaranteed they will get the last hit on any mob they target. Regeneration also counts towards participation.

*   **Shaman – Acolyte:** Extremely good AoE with Eldritch Call allows you to get a lot of participation and last hits on enemies. As the healing from Sacrificial Shrine counts towards participation, XP is almost guaranteed.

*   **Archer – Trapper:** They almost always one-shot mobs when they spawn in their traps, thus granting them easy last hits.

*   **Mage – Riftwalker:** Being a healer and still having access to Meteor makes getting participation easy. It's almost the same as Trapper with spawn killing, but it requires more mana and has a shorter range. Healing counts towards participation, granting you XP as well.

*   **Warrior:** Sadly, Warriors don't have it easy. They don't have the one-shot potential in any of their abilities, and healing is limited to over-health. Air Shout is mandatory for grinding as it allows you to target enemies at range. Provoke and Discombobulate act as debuffs that can grant you participation, but they are not as reliable. Heavenly Trumpet will also get you participation.

*   **Assassin:** I feel for you. As an Assassin, you will likely require a lot more time to grind because you do not have the AoE damage capabilities of the other classes, nor do you have buffs or debuffs that would gain you participation. So, you either go for sneaky last hits or solo your way to the end. In a grinding party, you can go away from the main group, kill a mob, and return to the group. This will net you a few seconds of full XP, but it comes with the problem of you not continuously getting XP. Since the Trickster rework, Noxious Haze could count as a buff for participation, but testing is still needed.
...
<details>
<summary><strong>Assassin</strong></summary>
...
If you have any questions, need clarification on a specific point, or have suggestions for improving this guide, please feel free to reach out to me. The best way to contact me is on Discord.
